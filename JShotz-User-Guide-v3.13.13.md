...
**Chrome / Edge**
1. Unzip `JShotz-3.13.13-chrome-edge.zip`.
...
**Firefox**
1. Unzip `JShotz-3.13.13-firefox.zip`.
...
new frames remain available for the final PDF. The popup changes its folder button to **Reconnect
capture folder**; select the original folder to write subsequent PNGs and the final PDF there
again.
